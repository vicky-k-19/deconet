...
import argparse
from synthetic_dataset import synthetic_generator, Synthetic
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=300,
        help="Artificial dimension for the synthetic signal. Default valued is 300",
    )
    ...
    parser.add_argument(
        "--red", type=int, default=3000, help="Redundancy factor. Default value =10*amb"
    )
...
def get_data_loaders(train_batch_size, val_batch_size):
    ...
    val_loader = DataLoader(val, num_workers=2, batch_size=val_batch_size, shuffle=True)
